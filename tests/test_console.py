#!/usr/bin/python
"""This module contains all the unittests for the console.py.
Unittest classes:
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for 'help' of the HBNB command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for 'exit' from the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for testing 'show' of the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for 'destroy' on the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Testing 'update' of the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests for the 'count' method of HBNB comand interpreter."""
