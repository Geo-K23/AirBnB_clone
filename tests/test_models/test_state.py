#!/usr/bin/python3
"""This defines tests for class State.
...
class Test_State_instantiation(unittest.TestCase):
    """This tests for instantiation of the State class """
    ...
    def test_str_representation(self):
        ...
        ststr = st.__str__()
        self.assertIn("[State] (45678)", ststr)
        self.assertIn("'id': '45678'", ststr)
...
class Test_State_to_dict(unittest.TestCase):
    """This is testing to_dict method of the State class"""
    ...
    def test_to_dict_contains_added_attributes(self):
        st = State()
        st.middle_name = "ALXSWE"
        st.my_number = 98
        self.assertEqual("ALXSWE", st.middle_name)
